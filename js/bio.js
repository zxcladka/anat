...
function renderHub() {
  ...
  app.innerHTML = `<div class="wrap">
    ...
    <div class="actions">${due ? `<a href="#/facts/all/learn"><button class="primary">Повторити ${due} →</button></a>` : ''}<a href="#/bio/gen"><button class="${due ? '' : 'primary'}">Генетичні задачі</button></a><a href="#/bio/ped"><button>Родоводи</button></a>${window.MICRO ? '<a href="#/micro"><button>Мікроскоп</button></a>' : ''}</div>
