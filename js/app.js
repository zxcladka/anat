...
function route() {
  ...
  setTitle({ today: 'Сьогодні', progress: 'Мій прогрес', my: 'Мої схеми', edit: 'Редагування', about: 'Про тренажер', decks: 'Колоди', blitz: 'Бліц', course: 'Курс', choose: 'Вибір курсу', krok: 'Крок 1', exam: 'Контроль', plan: 'План до модуля', guide: 'Як вчити', rules: 'Закономірності іннервації', bio: 'Медична біологія', facts: 'Теорія' }[parts[0]] || '');
...
function renderAbout() {
  ...
  app.innerHTML = `<div class="wrap"><div class="prose">
    ...
    <p>Картки (клітина, спадкові хвороби, паразити), послідовності «розстав по порядку» (мітоз, мейоз, цикли паразитів), генератор генетичних задач із решіткою Пеннета і родоводи з розбором через спростування типів успадкування.</p>
    <h2>3D-схеми</h2>
