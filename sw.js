...
const SHELL = ['./', './index.html', './manifest.json', './css/modules.css', './js/app.js', './js/decks.js', './js/blitz.js', './js/course.js', './js/krok.js', './js/facts.js',
  './atlas/data.js', './atlas/curriculum.js', './atlas/lexicon.js', './atlas/krok1.js', './atlas/facts.js', './atlas/bio.js', './js/bio.js', './atlas/rules.js', './js/exam.js', './js/plan.js', './js/rules.js', './atlas/micro.js', './js/micro.js', './icons/icon-192.png', './icons/icon-512.png',
