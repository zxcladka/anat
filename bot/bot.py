...
HELP = (
    ...
    "картки теорії (м’язи, суглоби, нерви), бліц, Крок 1, контроль на час, план до модуля, медична біологія.\n\n"
    "Команди:\n"
...
def handle(msg, users):
    ...
    if cmd == "/start":
        ...
        rows = [[("Атлант C I", "set/v3-atlas/study"), ("Осьовий C II", "set/v3-axis/study")], [("Шийний C IV", "set/v3-c4/study"), ("C VII (prominens)", "set/v3-c7/study")],
                ...
                [("Кістки кисті", "set/v3-hand/study"), ("Кульшова кістка", "set/v3-hip/study")], [("Таз", "set/v3-pelvis/study"), ("Стегнова кістка", "set/v3-femur/study")], [("Гомілка", "set/v3-tibia-fibula/study"), ("Кістки стопи", "set/v3-foot/study")]]
